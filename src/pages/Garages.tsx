...
const Garages = () => {
  const images = [
    { src: garage1, alt: "Garaža 1 - kvalitetna montažna garaža", title: "Garaža 1" },
    { src: garage2, alt: "Garaža 2 - kvalitetna montažna garaža", title: "Garaža 2" },
    { src: garage3, alt: "Garaža 3 - kvalitetna montažna garaža", title: "Garaža 3" },
    { src: garage4, alt: "Garaža 4 - kvalitetna montažna garaža", title: "Garaža 4" },
    { src: garage5, alt: "Garaža 5 - kvalitetna montažna garaža", title: "Garaža 5" },
    { src: garage6, alt: "Garaža 6 - kvalitetna montažna garaža", title: "Garaža 6" },
    { src: garage7, alt: "Garaža 7 - kvalitetna montažna garaža", title: "Garaža 7" },
    { src: garage8, alt: "Garaža 8 - kvalitetna montažna garaža", title: "Garaža 8" },
    { src: garage9, alt: "Garaža 9 - kvalitetna montažna garaža", title: "Garaža 9" },
    { src: garage10, alt: "Garaža 10 - kvalitetna montažna garaža", title: "Garaža 10" },
    { src: garage11, alt: "Garaža 11 - kvalitetna montažna garaža", title: "Garaža 11" },
    { src: garage12, alt: "Garaža 12 - kvalitetna montažna garaža", title: "Garaža 12" },
    { src: garage13, alt: "Garaža 13 - kvalitetna montažna garaža", title: "Garaža 13" },
    { src: garage14, alt: "Garaža 14 - kvalitetna montažna garaža", title: "Garaža 14" },
    { src: garage15, alt: "Garaža 15 - kvalitetna montažna garaža", title: "Garaža 15" },
    { src: garage16, alt: "Garaža 16 - kvalitetna montažna garaža", title: "Garaža 16" },
    { src: garage17, alt: "Garaža 17 - kvalitetna montažna garaža", title: "Garaža 17" },
    { src: garage18, alt: "Garaža 18 - kvalitetna montažna garaža", title: "Garaža 18" },
    { src: garage19, alt: "Garaža 19 - kvalitetna montažna garaža", title: "Garaža 19" },
    { src: garage20, alt: "Garaža 20 - kvalitetna montažna garaža", title: "Garaža 20" },
    { src: garage21, alt: "Garaža 21 - kvalitetna montažna garaža", title: "Garaža 21" }
  ];
